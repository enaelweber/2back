 ...
 */
final class Version20260218121022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_A4DFBE2F19C56181 ON revision_history');
        $this->addSql('ALTER TABLE revision_history CHANGE page_id_id pages_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE revision_history CHANGE pages_id page_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE revision_history ADD CONSTRAINT `FK_A4DFBE2F19C56181` FOREIGN KEY (page_id_id) REFERENCES page (id)');
        $this->addSql('CREATE INDEX IDX_A4DFBE2F19C56181 ON revision_history (page_id_id)');
    }
}
